...
public class MultiFilterPlainPrettyPrinterForTextNodesWithXML extends AbstractMultiFilterPrettyPrinter {

	private final boolean cdata;
	private final boolean comment;
	private final boolean ignoreInvalidTextNodeXML;

	public MultiFilterPlainPrettyPrinterForTextNodesWithXML(boolean cdata, boolean comment, boolean ignoreInvalidTextNodeXML, boolean declaration, String[] anonymizes, String[] prunes, char indentationCharacter, int indentationMultiplier) {
								...
								if(characterType == CharactersType.NONE) {
									if(anon) {
										...
										if(isEscapedXML(chars, offset, sourceStart)) {
											...
											// TODO add length check on decoded chars?
	...
	public String toString() {
		return "MultiFilterPlainPrettyPrinterForTextNodesWithXML [cdata=" + cdata + ", comment=" + comment + ", ignoreInvalidTextNodeXML=" + ignoreInvalidTextNodeXML + ", anonymizes="
				+ Arrays.toString(anonymizes) + ", prunes=" + Arrays.toString(prunes) + ", declaration=" + declaration + "]";
	}
