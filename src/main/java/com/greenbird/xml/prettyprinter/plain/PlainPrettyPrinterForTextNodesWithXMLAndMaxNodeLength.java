...
public class PlainPrettyPrinterForTextNodesWithXMLAndMaxNodeLength extends AbstractPrettyPrinter {
	...
	public PlainPrettyPrinterForTextNodesWithXMLAndMaxNodeLength(boolean cdata, boolean comment, boolean ignoreInvalidTextNodeXML, boolean declaration, int maxTextNodeLength, int maxCDATANodeLength, char indentationCharacter, int indentationMultiplier) {
	...
	public String toString() {
		return "PlainPrettyPrinterForTextNodesWithXMLAndMaxNodeLength [cdata=" + cdata + ", comment=" + comment + ", ignoreInvalidTextNodeXML=" + ignoreInvalidTextNodeXML + ", declaration="
				+ declaration + ", maxTextNodeLength=" + getMaxTextNodeLength() + ", maxCDATANodeLength=" + getMaxCDATANodeLength() + "]";
	}
