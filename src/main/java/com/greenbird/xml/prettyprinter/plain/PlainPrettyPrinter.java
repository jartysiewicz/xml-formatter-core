...
public class PlainPrettyPrinter extends AbstractPrettyPrinter {

	public PlainPrettyPrinter(boolean declaration, char indentationCharacter, int indentationMultiplier) {
		super(declaration, indentationCharacter, indentationMultiplier);
	}

	public PlainPrettyPrinter(boolean declaration) {
		super(declaration);
	}
	...
	public String toString() {
		return "PlainPrettyPrinter [declaration=" + declaration + "]";
	}
