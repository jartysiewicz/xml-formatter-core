...
public class MultiFilterPlainPrettyPrinter extends AbstractMultiFilterPrettyPrinter {

	public MultiFilterPlainPrettyPrinter(boolean declaration, String[] anonymizes, String[] prunes, char indentationCharacter, int indentationMultiplier) {
